import EnviaConsoleLog01WhenCustomerIsCreated from "../../customer/event/handler/EnviaConsoleLog1Handler";
import EnviaConsoleLog02WhenCustomerIsCreated from "../../customer/event/handler/EnviaConsoleLog2Handler";
import SendEmailWhenProductIsCreatedHandler from "../../product/event/handler/send-email-when-product-is-created.handler";
import ProductCreatedEvent from "../../product/event/product-created.event";
import CustomerCreatedEvent from "../../customer/event/customer-created.event";
import EventDispatcher from "./event-dispatcher";
import CustomerAddressChangedEvent from "../../customer/event/customer-address-changed.event";
import EnviarConsoleLogWhenAddressIsChanged from "../../customer/event/handler/EnviarConsoleLogWhenAddressIsChanged";
